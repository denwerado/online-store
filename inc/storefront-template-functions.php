...
if ( ! function_exists( 'storefront_display_comments' ) ) {
	/** Комментарии к витрине магазина
	 * @since  1.0.0 */
...
if ( ! function_exists( 'storefront_comment' ) ) {
	/** Шаблон комментария на витрине магазина
...
if ( ! function_exists( 'storefront_footer_widgets' ) ) {
	/** Отображение областей виджета нижнего колонтитула.
	 * @since  1.0.0
	 * @return void */
	function storefront_footer_widgets() {
		...
		for ( $row = 1; $row <= $rows; $row++ ) :
			...
			//Определяет количество активных столбцов в этой строке нижнего колонтитула.
...
if ( ! function_exists( 'storefront_site_branding' ) ) {
	/** Фирменная оболочка и дисплей сайта
	 * @since  1.0.0
	 * @return void */
...
if ( ! function_exists( 'storefront_site_title_or_logo' ) ) {
	/** Отображать название сайта или логотип
	 * @since 2.1.0
...
if ( ! function_exists( 'storefront_primary_navigation' ) ) {
	...
	function storefront_primary_navigation() {
		?>
		<nav id="site-navigation" class="main-navigation header__nav" role="navigation" aria-label="<?php esc_attr_e( 'Primary Navigation', 'storefront' ); ?>">
			<ul class="goodville-ul header__navigation">
				<li class="item">
...
if ( ! function_exists( 'storefront_homepage_header' ) ) {
	/** Отображать заголовок страницы без отображаемого изображения
	 * @since 1.0.0 */
...
if ( ! function_exists( 'storefront_post_header' ) ) {
	...
	function storefront_post_header() {
		...
		/** Функции, подключенные к storefront_post_header_before действию.
...
if ( ! function_exists( 'storefront_post_content' ) ) {
	/** Отображать содержимое публикации со ссылкой на одно сообщение
	 * @since 1.0.0 */
	function storefront_post_content() {
		...
		/** Функции, подключенные к storefront_post_content_before действию.
...
if ( ! function_exists( 'storefront_edit_post_link' ) ) {
	/** Отобразить ссылку для редактирования
	 * @since 2.5.0 */
...
if ( ! function_exists( 'storefront_paging_nav' ) ) {
	/** Отображение навигации к следующему / предыдущему набору сообщений, если это применимо. */
...
if ( ! function_exists( 'storefront_post_nav' ) ) {
	/** Отображение навигации к следующему / предыдущему сообщению, когда это применимо. */
...
if ( ! function_exists( 'storefront_homepage_content' ) ) {
	/** Отображать содержимое главной страницы
...
if ( ! function_exists( 'storefront_social_icons' ) ) {
	 ...
	 * Если плагин "подписаться и подключиться" активен, отобразите значки.
...
if ( ! function_exists( 'storefront_get_sidebar' ) ) {
	/** Отображать боковую панель витрины магазина
	 * @uses get_sidebar()
	 * @since 1.0.0 */
...
if ( ! function_exists( 'storefront_post_thumbnail' ) ) {
	/** Отобразить миниатюру сообщения
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper' ) ) {
	/** Основная оболочка навигации */
	function storefront_primary_navigation_wrapper() {
		echo '<div class="storefront-primary-navigation goodville-container goodville-container__left-padding">
				<div class="col-full goodville-header__block">
					<a href="/" class="header__logo_mobile">
						<svg><use xlink:href="#site-logo"></use></svg>
					</a>';
	}
}
...
if ( ! function_exists( 'storefront_primary_navigation_wrapper_close' ) ) {
	/** Основная оболочка навигации закрывается */
	function storefront_primary_navigation_wrapper_close() {
		echo '		<div class="goodville-header__burger">
						<div class="line"></div>
					</div>	
				</div>
			</div>';
