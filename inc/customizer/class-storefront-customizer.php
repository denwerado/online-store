<?php
	...
	if ( ! class_exists( 'Storefront_Customizer' ) ) :
		...
		class Storefront_Customizer {
			...
			/** Возвращает массив желаемых параметров витрины магазина по умолчанию
			 * @return array */
			...
			/** Добавляет значение к каждому параметру витрины магазина, если он еще не присутствует.
			...
			/** Установите настройки настройщика по умолчанию.
			 * Эти значения по умолчанию необходимо применять отдельно, так как дочерние темы могут фильтровать значения storefront_setting_default_values
			...
			/** Добавьте поддержку почтовых сообщений для заголовка и описания сайта для настройщика темы, а также несколько других настроек.
			 * @param WP_Customize_Manager $wp_customize Theme Customizer object.
			 * @since  1.0.0 */

			public function customize_register( $wp_customize ) {

				//Переместите настройку цвета фона рядом с фоновым изображением.
				$wp_customize->get_control( 'background_color' )->section  = 'background_image';
				$wp_customize->get_control( 'background_color' )->priority = 20;

				//Измените заголовок и приоритет раздела фонового изображения.
				$wp_customize->get_section( 'background_image' )->title    = __( 'Background', 'storefront' );
				$wp_customize->get_section( 'background_image' )->priority = 30;

				//Измените заголовок и приоритет раздела изображения заголовка.
			...
			/** Получите все тематические моды для Storefront.
			...
			/** Получите css-настройщик Gutenberg.
			 * @see get_storefront_theme_mods()
			 * @return array $styles the css */
			...
			/** Поставьте в очередь динамические цвета для использования блоков редактора.
			 * @since 2.4.0 */
			...
			/** Layout classes
			 * Добавляет классы "правая боковая панель" и "левая боковая панель" в тег тела
			...
			/** Добавьте CSS для пользовательских элементов управления
			...
			/** Проверьте, используется ли на текущей странице шаблон домашней страницы.
			 * @since 2.3.0
			 * @return bool */
