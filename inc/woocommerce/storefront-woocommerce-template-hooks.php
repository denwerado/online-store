...
//add_action( 'woocommerce_after_single_product_summary', 'storefront_single_product_pagination', 30 ); //Отключили навигацию к след и предыд. продукту
...
//add_action( 'storefront_header', 'storefront_product_search', 40 ); // Отключили поиск товаров
add_action( 'storefront_header', 'storefront_header_cart', 60 );

/** Footer 
 * @see storefront_product_search()
*/
add_action( 'storefront_footer_search', 'storefront_product_search', 40);
