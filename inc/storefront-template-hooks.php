<?php
/** Storefront hooks - хуки для темы (хуки wooCommerce находятся в папке wooCommerce)
 * @package storefront */
...
//add_action( 'storefront_header', 'storefront_site_branding', 20 ); //Убрали верхние надписи бренда сайта
